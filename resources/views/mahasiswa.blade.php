                ...
                <form action="#" id="form-edit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input minlength="3" maxlength="50" required type="text" placeholder="Nama..." class="form-control" id="nama1"
                                name="nama">
                        </div>
                        <div class="form-group">
                            <label for="tempat-lahir">Tempat Lahir: </label>
                            <input minlength="3" maxlength="50" required type="text" placeholder="Tempat Lahir..." class="form-control"
                                id="tempat-lahir1" name="tempat_lahir">
                        </div>
                        <div class="form-group">
                            <label for="tanggal-lahir">Tanggal Lahir: </label>
                            <input  required type="date" placeholder="Tanggal Lahir" class="form-control"
                                id="tanggal-lahir1" name="tgl_lahir">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea minlength="5" maxlength="200" required class="form-control" id="alamat1" rows="3" name="alamat"></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="#" id="form-tambah">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama">Nama: </label>
                            <input required minlength="3" maxlength="50" type="text" placeholder="Nama..." class="form-control" id="nama"
                                name="nama">
                        </div>
                        <div class="form-group">
                            <label for="tempat-lahir">Tempat Lahir: </label>
                            <input required minlength="3" maxlength="50" type="text" placeholder="Tempat Lahir..." class="form-control"
                                id="tempat-lahir" name="tempat_lahir">
                        </div>
                        <div class="form-group">
                            <label for="tanggal-lahir">Tanggal Lahir: </label>
                            <input required type="date" placeholder="Tanggal Lahir" class="form-control"
                                id="tanggal-lahir" name="tgl_lahir">
                        </div>
                        <div class="form-group">
                            <label>Jenis Kelamin: </label>
                            <div class="form-check">
                        ...
                        <div class="form-group mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea minlength="5" maxlength="200" required class="form-control" id="alamat" rows="3" name="alamat"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
    ...
    <div class="modal fade text-left" id="delete-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah kamu yakin ingin menghapus data dari `mahasiswa`? Data yang dihapus tidak akan bisa
                    dikembalikan!
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("form-tambah").addEventListener("submit", function (e) {
                ...
                axios.post(url, {
                    ...
                    .catch(function (error) {
                        ...
                        setAlert("Data gagal ditambahkan!", "danger", "file-excel")
                        console.log(error);
                    });
            });
            ...
            document.getElementById("form-edit").addEventListener("submit", function (e) {
                ...
                axios.put(url, {
                    ...
                    .catch(function (error) {
                        loaderWrapper.classList.remove('show');
                        setAlert("Data gagal diedit!", "danger", "file-excel")
                        console.log(error);
                    });
            });
            ...
            document.getElementById("confirm-hapus").addEventListener("click", function (e) {
                ...
                axios.delete(url);
                getDataMahasiswa();
                setAlert("Data berhasil dihapus!", "success", "check-circle")
            ...
            axios.get(url).then(function (response) {
                    ...
                    if (mahasiswa.total > 0) {
                        ...
                        if (mahasiswa.last_page > 1) {
                            ...
                            //
                            pageData += '<li class="page-item ' + firstPage + '"><a class="page-link" href="' +
                                firstUrl + '">First</a></li>' +
                                '<li class="page-item ' + firstPage + '"><a class="page-link" href="' + prevUrl +
                                '">Previous</a></li>';
                            ...
                            for (var i = 1; i <= mahasiswa.last_page; i++) {
                                ...
                                pageData += '<li class="page-item ' + activePage + '"><a class="page-link" href="' +
                                    pageUrl + '">' + i + '</a></li>';
                            }

                            pageData += '<li class="page-item ' + lastPage + '"><a class="page-link" href="' +
                                nextUrl + '">Next</a></li>' +
                                '<li class="page-item ' + lastPage + '"><a class="page-link" href="' + lastUrl +
                                '">Last</a></li>';
